...
name_to_actor_id = {
    "Body Pose Estimation App.replayer_source": 1,
    "Body Pose Estimation App.preprocessor": 4,
    "Body Pose Estimation App.transpose": 6,
    "Body Pose Estimation App.inference": 8,
    "Body Pose Estimation App.postprocessor" : 10,
    "Body Pose Estimation App.holoviz":11 

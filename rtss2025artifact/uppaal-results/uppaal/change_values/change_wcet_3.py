...
name_to_actor_id = {
    "Colonoscopy App.replayer": 1,
    "Colonoscopy App.segmentation_preprocessor": 4,
    "Colonoscopy App.segmentation_inference_holoinfer": 6,
    "Colonoscopy App.segmentation_postprocessor": 8,
    "Colonoscopy App.segmentation_visualizer" : 9 

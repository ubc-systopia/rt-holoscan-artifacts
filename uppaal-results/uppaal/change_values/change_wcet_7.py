...
name_to_actor_id = {
    "Multi AI App.replayer": 1,
    "Multi AI App.detection_preprocessor":5,
    "Multi AI App.multi_ai_inference": 7,
    "Multi AI App.detection_postprocessor":9,
    "Multi AI App.segmentation_postprocessor":11,
    "Multi AI App.segmentation_preprocessor":12,
    "Multi AI App.holoviz":13
}
